package com.dalingge.coinvista.core.design.theme
 ...
 * 适用场景：正文内容、次要标题
 */
val TextSecondaryLight = Color(0xFF686868) // 用于普通内容

/**
 * 浅色模式下三级文字颜色：#9A999D
 * 适用场景：辅助说明、标签文字
 */
val TextTertiaryLight = Color(0xFF9A999D) // 用于底部标签描述

/**
 * 浅色模式下四级文字颜色：#CCCCCC
 * 适用场景：次要辅助信息、禁用状态文字
 */
val TextQuaternaryLight = Color(0xFfb9babb) // 用于辅助次要信息
 ...
 * 适用场景：应用整体背景、页面底色
 */
val BgGreyLight = Color(0xFFF8F8F8) // 页面背景底色
 ...
 * 适用场景：分割线、边框、描边等
 */
val BorderLight = Color(0xFFEFEFF3) // 浅色模式边框
