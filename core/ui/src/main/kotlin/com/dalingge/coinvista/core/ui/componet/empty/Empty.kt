...
import com.dalingge.coinvista.core.design.theme.SpacePaddingLarge
import com.dalingge.coinvista.core.design.theme.SpaceVerticalSmall
import com.dalingge.coinvista.core.design.theme.SpaceVerticalXLarge
import com.dalingge.coinvista.core.design.theme.appTextColors
...
fun Empty(
    ...
    message: Int = R.string.empty_data,
    subtitle: Int? = null,
    retryButtonText: Int = R.string.click_retry,
    icon: Int = R.drawable.ic_empty_data,
